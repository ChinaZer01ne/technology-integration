...
insert  into `t_permission`(`id`,`parent_id`,`name`,`en_name`,`url`,`description`,`created`,`updated`) values
...
insert  into `t_role`(`id`,`parent_id`,`name`,`en_name`,`description`,`created`,`updated`) values
...
insert  into `t_user`(`id`,`username`,`password`,`phone`,`email`,`created`,`updated`) values
